...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[[DemoCollectionViewController alloc] initWithNibName:@"DemoCollectionViewController" bundle:nil] autorelease];
    ...
    [self.window setRootViewController:self.navigationController]; //Does window send release to rootViewController?
